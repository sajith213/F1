...
function validateForm() {
    ...
    const categoryType = document.getElementById('type').value;
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Debug: Check if category name field exists
    const categoryNameField = document.getElementById('category_name');
    if (!categoryNameField) {
        console.error('Category name field not found!');
    } else {
        console.log('Category name field found and ready');
        // Ensure the field is visible
        categoryNameField.style.display = 'block';
        categoryNameField.style.visibility = 'visible';
    }
});
</script>
